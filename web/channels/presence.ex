defmodule Lunatube.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Lunatube.MyChannel do
        use Lunatube.Web, :channel
        alias Lunatube.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :lunatube,
                        pubsub_server: Lunatube.PubSub
end
